...
try:
    ...
    # DEFINITIVE FIX: Download all required NLTK data packages.
    # 'punkt' is for tokenization, 'averaged_perceptron_tagger' is a dependency for `unstructured`.
...
def handle_chat_interaction(prompt, provider, model, temp, mode):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            output = f"⚠️ **API Quota Exceeded for {provider}:** Please check your plan and billing details."
            st.error(output)
        except Exception as e:
